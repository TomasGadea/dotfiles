...
set matchpairs+=<:>
set showmatch
hi MatchParen cterm=bold ctermbg=darkgray ctermfg=darkmagenta
...
"set expandtab  he desactivat aixo perque trencava els makefiles...
...
" switch between paste and nopaste mode in INSERT
set pastetoggle=<F1>
